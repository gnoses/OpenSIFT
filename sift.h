...
/**
   ...
   @see _sift_features()
*/
extern int sift_features( IplImage* img, struct SIFTFeature** feat );
...
/**
   ...
   @see sift_features()
*/
extern int _sift_features( IplImage* img, struct SIFTFeature** feat, int intvls,
