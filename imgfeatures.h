...
struct SIFTFeature
{
  ...
  struct SIFTFeature* fwd_match;     /**< matching feature from forward image */
  struct SIFTFeature* bck_match;     /**< matching feature from backmward image */
  struct SIFTFeature* mdl_match;     /**< matching feature from model */
...
*/
extern int import_features( char* filename, int type, struct SIFTFeature** feat );
...
*/
extern int export_features( char* filename, struct SIFTFeature* feat, int n );
...
/**
   ...
   @param n number of features
*/
extern void draw_features( IplImage* img, struct SIFTFeature* feat, int n );
...
/**
   ...
   @return Returns the squared Euclidian distance between the descriptors of
     \a f1 and \a f2.
*/
extern double descr_dist_sq( struct SIFTFeature* f1, struct SIFTFeature* f2 );
