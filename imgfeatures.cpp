...
static int import_oxfd_features( char*, struct SIFTFeature ** );
static int export_oxfd_features( char*, struct SIFTFeature *, int );
static void draw_oxfd_features( IplImage*, struct SIFTFeature *, int );
static void draw_oxfd_feature( IplImage*, struct SIFTFeature *, CvScalar );

static int import_lowe_features( char*, struct SIFTFeature ** );
static int export_lowe_features( char*, struct SIFTFeature *, int );
static void draw_lowe_features( IplImage*, struct SIFTFeature *, int );
static void draw_lowe_feature( IplImage*, struct SIFTFeature *, CvScalar );
...
*/
int import_features( char* filename, int type, struct SIFTFeature** feat )
{
  int n;
...
*/
int export_features( char* filename, struct SIFTFeature* feat, int n )
{
  int r, type;
...
/*
  ...
  @param n number of features
*/
void draw_features( IplImage* img, struct SIFTFeature* feat, int n )
{
  int type;
...
/*
  ...
  @return Returns the squared Euclidian distance between the descriptors of
    f1 and f2.
*/
double descr_dist_sq( struct SIFTFeature* f1, struct SIFTFeature* f2 )
{
  double diff, dsq = 0;
...
/*
  ...
  @return Returns the number of features imported from filename or -1 on error
*/
static int import_oxfd_features( char* filename, struct SIFTFeature** features )
{
  struct SIFTFeature* f;
  int i, j, n, d;
  double x, y, a, b, c, dv;
  FILE* file;
  ...
  f = (SIFTFeature*)calloc( n, sizeof(struct SIFTFeature) );
  for( i = 0; i < n; i++ )
    {
...
/*
  ...
  @return Returns 0 on success or 1 on error
*/
static int export_oxfd_features( char* filename, struct SIFTFeature* feat, int n )
{
  FILE* file;
  int i, j, d;
...
/*
  ...
  @param n number of features
*/
static void draw_oxfd_features( IplImage* img, struct SIFTFeature* feat, int n )
{
...
*/
static void draw_oxfd_feature( IplImage* img, struct SIFTFeature* feat,
			       CvScalar color )
{
...
/*
  ...
  @return Returns the number of features imported from filename or -1 on error
*/
static int import_lowe_features( char* filename, struct SIFTFeature** features )
{
  struct SIFTFeature* f;
  int i, j, n, d;
  double x, y, s, o, dv;
...
/*
  ...
  @return Returns 0 on success or 1 on error
*/
static int export_lowe_features( char* filename, struct SIFTFeature* feat, int n )
{
  FILE* file;
  int i, j, d;
...
/*
  ...
  @param n number of features
*/
static void draw_lowe_features( IplImage* img, struct SIFTFeature* feat, int n )
{
  CvScalar color = CV_RGB( 255, 255, 255 );
  int i;
...
/*
  ...
  @param color color in which to draw
*/
static void draw_lowe_feature( IplImage* img, struct SIFTFeature* feat,
			       CvScalar color )
{
