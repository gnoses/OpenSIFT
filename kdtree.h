...
struct kd_node
{
  ...
  struct SIFTFeature* features;    /**< features at this node */
...
*/
extern struct kd_node* kdtree_build( struct SIFTFeature* features, int n );
...
/**
   ...
   @return Returns the number of neighbors found and stored in \a nbrs, or
     -1 on error.
*/
extern int kdtree_bbf_knn( struct kd_node* kd_root, struct SIFTFeature* feat,
